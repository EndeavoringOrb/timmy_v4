...
vocab_size = 8192 # this needs to be the same size as the vocab size. so if you load "wiki.model", go to "wiki.vocab" and see how many lines there are. that is the vocab size you should use
load_amount = 0 # set to 0 if you want to load everything
text_file = "shakespeare.txt"
sentence_piece_model = "wiki"
